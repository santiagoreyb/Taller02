...
import com.example.taller_0202.databinding.ActivityMapsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLocationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                /*
                Log.i("LOCATION",
                    "iniLo: ${initialLongitude}. " +
                    "iniLa: ${initialLatitude}. " +
                    "ActLo: ${longitude}. " +
                    "ActLa: ${latitude}. " +
                    "Diff: ${distanceDifference.toString()}."
                )
                */
                if (distanceDifference!! >= 30.0) {
                    mMap.clear()
        ...
        lightSensorListener = object : SensorEventListener {
            override fun onSensorChanged(event: SensorEvent) {
                if (event.values[0] < 5000) {
                    ...
                    mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(this@MapsActivity, R.raw.style_json_dark))
                } else {
                    // Log.i("MAPS", "LIGHT MAP " + event.values[0])
                    mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(this@MapsActivity, R.raw.style_json))
                }
            }
